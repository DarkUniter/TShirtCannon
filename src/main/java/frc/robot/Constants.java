...
public class Constants {
	...
	//Cannon
	public static final int TICKS_PER_REVOLUTION = 1000;
	public static final int NUMBER_OF_CHAMBERS = 8;
	public static final int TICKS_PER_CHAMBER = TICKS_PER_REVOLUTION/NUMBER_OF_CHAMBERS; 
